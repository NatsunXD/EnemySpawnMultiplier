...
The builder verifies the supported EXE and game.dll hashes, compiles all configured Lua variants, runs synthetic memory checks, and inspects each archive in Python. It writes `releases/Enemy-Spawn-Multiplier-6x-Native-Composition-v18.zip`, `releases/Enemy-Spawn-Multiplier-6x-Light-Medium-Bias-v18.zip`, and `releases/Enemy-Spawn-Multiplier-Fast-Cadence-v18.zip`. Pass `base`, `light-medium`, or `fast-cadence` to build only one variant. It does not install or launch the game.
